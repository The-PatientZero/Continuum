...
extension Bundle {
    ...
    /// cannot be found for either key, this accessor returns `Continuum`.
...
extension NSScreen {
    ...
    /// The connected screens Continuum manages.
    ...
    /// OverlayTray item sizes) and the live window-list query may not yet be
    /// available.

...
/// App-specific constants for the main Continuum target.
...
enum Constants {
    ...
    static let repositoryURLInfoPlistKey = "ContinuumRepositoryURL"

    /// Info.plist key used to configure the donation URL.
    static let donateURLInfoPlistKey = "ContinuumDonateURL"

...
extension ControlItemImageSet {
    /// The default image set for the control icon.
    static let defaultControlIcon = ControlItemImageSet(
        name: .cube,
        hidden: .catalog("ContinuumCubeStroke"),
        visible: .catalog("ContinuumCubeFill")
    )

    /// The image sets that the user can choose to display in the control icon.
    static let userSelectableControlIcons = [
        ControlItemImageSet(
            name: .arrow,

...
///
/// Log files are written to `~/Library/Logs/Continuum/`.
final class DiagnosticLogger: @unchecked Sendable {
    ...
    private let osLog = Logger(
        subsystem: Bundle.main.bundleIdentifier ?? "com.thepatientzero.Continuum",
    ...
    private let writeQueue = DispatchQueue(
        label: "com.thepatientzero.Continuum.DiagnosticLogger.writeQueue",
        qos: .utility
    )
    ...
    private func openLogFile() {
        ...
        let fileName = "continuum_\(fileNameFormatter.string(from: Date())).log"

...
///
/// Pins down the LCS-anchored move ordering used by applySavedSectionLayout's
...
final class PlanLCSMoveSequenceTests: XCTestCase {
    ...
    func testVisibleBoundaryMoveRestoresHiddenItemWhoseOrderLooksUnchangedWithoutControls() {
        let result = LayoutSolver.planVisibleBoundaryMoves(
            currentSectionByUID: [
                "a": .visible,
                "b": .hidden,
            ],
    ...
    func testVisibleBoundaryMoveHidesVisibleItemWhoseOrderLooksUnchangedWithoutControls() {
        let result = LayoutSolver.planVisibleBoundaryMoves(
            currentSectionByUID: [
                "a": .visible,
                "b": .visible,
        ...
        XCTAssertEqual(result, [
            LayoutSolver.LCSPlannedMove(uid: "b", destination: .sectionBoundary(.hidden)),
        ])
    }

...
final class LayoutResetErrorTests: XCTestCase {
    ...
    func testMissingAppStateError() {
        let error = MenuBarLayoutResetError.missingAppState
        XCTAssertNotNil(error)
    }

    func testMissingControlItemsError() {
        let error = MenuBarLayoutResetError.missingControlItems
        XCTAssertNotNil(error)
    }
    ...
    func testConformsToLocalizedError() {
        let error: LocalizedError = MenuBarLayoutResetError.missingAppState
    ...
    func testSameErrorsAreEqual() {
        let error1 = MenuBarLayoutResetError.missingAppState
        let error2 = MenuBarLayoutResetError.missingAppState
    ...
    func testDifferentErrorsAreNotEqual() {
        let error1 = MenuBarLayoutResetError.missingAppState
        let error2 = MenuBarLayoutResetError.missingControlItems
    ...
    func testAllCasesHaveDescriptions() throws {
        let allCases: [MenuBarLayoutResetError] = [
            .missingAppState,
            .missingControlItems,
        ]
    ...
    private func errorsAreEqual(_ lhs: MenuBarLayoutResetError, _ rhs: MenuBarLayoutResetError) -> Bool {
        switch (lhs, rhs) {

...
/// the ordered currentFlat sequence applySavedSectionLayout and the log-replay
/// harness both consume.
final class FlattenCurrentSectionsTests: XCTestCase {
    private let hiddenCtrl = "com.thepatientzero.Continuum:Continuum.ControlItem.Hidden"
    private let ahCtrl = "com.thepatientzero.Continuum:Continuum.ControlItem.AlwaysHidden"
    ...
    func testOrderWithAlwaysHiddenPresent() {
        let visibleCtrl = "com.thepatientzero.Continuum:Continuum.ControlItem.Visible"

...
enum ControlCenterHostedResolutionLog {
    /// Little Snitch agent icon, from continuum_2026-06-08_20-54-21.log (beta.15,
    ...
    /// com.apple.controlcenter and starves marker-pair resolution.
    ...
    /// continuum_2026-06-03_09-44-18.copy.log (beta.14 diagnostic build 37dfb6a),
